...
1. Presentation time is PAGE_PRESENTATION_TIME minutes **MAX**<br>
 * we will give you a PAGE_PLAYOFF_TIME1 minute and 1 minute warning and then we will play you off!
...
1. Presentation time is PAGE_PRESENTATION_TIME minutes **MAX**
 * we will give you a PAGE_PLAYOFF_TIME1 minute and 1 minute warning and then we will play you off!
 ...
 * make sure you bring in any connectors/dongles you might need (the connection is HDMI in class)
 * you can use presenter notes, but we should not be able to tell you are using them 
4. We will start exactly at PAGE_CLASS_STARTTIME in order to fit all presentations in on PAGE_ONETWODAYS
 ...
 * make sure you bring in any connectors/dongles you might need (the connection is HDMI in class)
 * you can use presenter notes, but we should not be able to tell you are using them 
4. We will start exactly at 3:05pm in order to fit all presentations in on PAGE_ONETWODAYS
